...
public class SourceStructure {
	 ...
	 * @throws Exception
	 */
	public SourceStructure(File file) throws Exception{
		...
		classStructures.add(new ClassStructure(sourceClass,0));
	 ...
	 * @return
	 */
	public ClassStructure getSourceClassStructure(){
	...
	private ArrayList<ClassStructure> classStructures = new ArrayList<ClassStructure>();
}
