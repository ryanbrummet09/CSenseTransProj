...
public class ClassStructure3 {
	...
	public ClassStructure3(ClassNode2 targetClass, int depth){	
		...
		instanceFields = new ArrayList<String>();
		findFieldTypes();
	}
	 ...
	 */
	public ArrayList<String> getStaticFields(){
		return staticFields;
	}
	 ...
	 */
	public ArrayList<String> getInstanceFields(){
			...
			for(int i = 0; i < methodStructures.get(m).getNumUniqueBlocks(); i++){
				for(int j = 0; j < methodStructures.get(m).getBlockStructures().get(i).getNumBlockInsn(); j++){
					if(methodStructures.get(m).getBlockStructures().get(i).getBlockInsnNumber(j).getOpcode() == Constants.OPCODE_PUTSTATIC){
						if(!staticFields.contains(((FieldInsnNode) methodStructures.get(m).getBlockStructures().get(i).getBlockInsnNumber(j)).name)){
							staticFields.add(((FieldInsnNode) methodStructures.get(m).getBlockStructures().get(i).getBlockInsnNumber(j)).name);
						}
					} else if(methodStructures.get(m).getBlockStructures().get(i).getBlockInsnNumber(j).getOpcode() == Constants.OPCODE_PUTFIELD){
						if(!instanceFields.contains(((FieldInsnNode) methodStructures.get(m).getBlockStructures().get(i).getBlockInsnNumber(j)).name)){
							instanceFields.add(((FieldInsnNode) methodStructures.get(m).getBlockStructures().get(i).getBlockInsnNumber(j)).name);
						}
					}
				}
			}
	...
	private ArrayList<String> instanceFields;
}
