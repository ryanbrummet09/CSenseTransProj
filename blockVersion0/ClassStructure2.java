...
public class ClassStructure2 {
	 ...
	 * @param depth
	 */
	public ClassStructure2(ClassNode2 targetClass, int depth){	
		...
		for(int i = 0; i < methodNodes.size(); i++){
			MethodStructure2 tempMS = new MethodStructure2(methodNodes.get(i));
	 ...
	 * @throws IOException
	 */
	public ClassStructure2(String targetClassName, int depth) throws IOException{
	...
	private int depth;
	private ArrayList<MethodStructure2> methodStructures = new ArrayList<MethodStructure2>();
}
