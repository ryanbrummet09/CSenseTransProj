...
public class ProcessedVariable {
	 ...
	 */
	public ProcessedVariable(String rawName, String rawType, int existNumber, MethodStructure3 mn, int startOfBlockScope, boolean needsAdjustment, int address){
	 ...
	 * @param needsAdjustment
	 */
	public ProcessedVariable(String rawName, String rawType, int existNumber, String className, int address){
		this.rawName = rawName;
		this.existNumber = existNumber;
		this.address = address;
		if(rawType.equals("I")){
	...
	/**
	 * 
	 * @return returns the index that this object is located at in its corresponding object array
	 */
	...
	/**
	 * adjusts the address so as to reassign this object to the value of another object of the same type.
	 * @param newValue
	 */
	public void setAddress(int newValue){
		address = newValue;
	}
	 ...
	 */
	public void reAdjust(String rawType, MethodStructure3 mn, int startScope, int address){
